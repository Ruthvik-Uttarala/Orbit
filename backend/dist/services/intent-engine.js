...
const INTENT_PATTERNS = [
    {
        intent: types_1.IntentType.DEPLOY,
        flow: 'deploy-flow',
    ...
    {
        intent: types_1.IntentType.BUILD,
        flow: 'build-flow',
    ...
    {
        intent: types_1.IntentType.UPDATE,
        flow: 'update-flow',
    ...
    {
        intent: types_1.IntentType.TEST,
        flow: 'test-flow',
    ...
    {
        intent: types_1.IntentType.ROLLBACK,
        flow: 'rollback-flow',
    ...
    {
        intent: types_1.IntentType.STATUS,
        flow: 'status-check',
 ...
 */
function extractParameters(input, intent) {
    ...
    if (intent === types_1.IntentType.UPDATE || intent === types_1.IntentType.CREATE) {
 ...
 */
function scoreIntent(input, pattern) {
    const normalized = normalizeInput(input);
 ...
 */
function getIntentDescription(result) {
    switch (result.intent) {
        case types_1.IntentType.DEPLOY:
