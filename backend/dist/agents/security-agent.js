...
exports.securityAgent = exports.SecurityAgent = void 0;
const base_agent_1 = require("./base-agent");
const types_1 = require("../services/types");
class SecurityAgent extends base_agent_1.BaseAgent {
    constructor() {
        super(types_1.AgentType.SECURITY, 'Security Agent', 'Scans for vulnerabilities, checks compliance, and enforces security policies', ['scan-dependencies', 'scan-code', 'check-secrets', 'compliance-check', 'security-report']);
    }
    ...
    async scanDependencies(input, execution) {
    ...
    async scanCode(input, execution) {
    ...
    async checkSecrets(input, execution) {
    ...
    async complianceCheck(input, execution) {
    ...
    async fullScan(input, execution) {
...
exports.securityAgent = new SecurityAgent();
